...
export default function KalkulatorPPh21() {
  ...
  const adaKelebihan = (hasilTahunan.kelebihanPotong ?? 0) > 0;
          ...
          <Card>
            ...
            <div className="space-y-4">
              ...
              <RupiahInput
                ...
                hint="Untuk menghitung kurang/lebih potong pada masa Desember."
              />
            </div>
          </Card>
          ...
          <div className="space-y-4">
            <HasilUtama
              ...
              keterangan={
                dipotongJanNov > 0
                  ? adaKelebihan
                    ? `Kelebihan potong dikembalikan ke karyawan: ${formatRupiah(hasilTahunan.kelebihanPotong ?? 0)}`
            ...
            <Card>
              ...
              {dipotongJanNov > 0 && (
                <>
                  ...
                  {adaKelebihan ? (
                    <BarisHasil
                      label="Kelebihan potong (dikembalikan bersama gaji Desember)"
                      nilai={hasilTahunan.kelebihanPotong ?? 0}
                      tebal
                    />
                  ) : (
                    <BarisHasil
